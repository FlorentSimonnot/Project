...
import kotlinx.android.synthetic.main.list_item_message.view.message
...
import kotlinx.android.synthetic.main.list_item_message_with_identity.view.*
...
class MessageAdapterChatEvent(
...
) : RecyclerView.Adapter<MessageAdapterChatEvent.ViewHolder>() {
    ...
    inner class AddresseeMessage(view : View) : ViewHolder(view){
        ...
        override fun bind(message: Message) {
            ...
            SessionUser(context).writeInfoUser(context, message.sender.key, identity, "identity")
            text.setOnClickListener {
                if(time.visibility == View.GONE){
                    time.visibility = View.VISIBLE
                }
